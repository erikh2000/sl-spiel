...
// +my edits = Minor edits for linting and making it Webpack-friendly
...
function parse(script:any, toks:any, callback:any) {
...
const fountain = function (script:any, callback:any) {
  return fountain.parse(script, callback);
};

fountain.parse = function (script:any, tokens:any, callback?:any) {
